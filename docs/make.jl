...
notebooks = ["Feature Importance" => joinpath(folder, "pluto_fi.md"),
...
Documenter.makedocs(; modules   = [MagNav],
                    sitename  = "MagNav.jl",
...
Documenter.deploydocs(; repo="github.com/MIT-AI-Accelerator/MagNav.jl.git")
