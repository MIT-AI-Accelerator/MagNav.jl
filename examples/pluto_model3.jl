...
Select Flight 1006 (see [readme](https://github.com/MIT-AI-Accelerator/MagNav.jl/blob/master/readmes/Flt1006_readme.txt)), load the flight data, and get the Boolean indices for a specific calibration flight line that will be used to fit the Tolles-Lawson coefficients.
"

# ╔═╡ bf9f72f0-c351-48d3-a811-418ee965073c
flight_train = :Flt1006; # select flight, full list of SGL flights is in df_flight
...
begin # select a calibration flight line to train Tolles-Lawson on
	...
	TL_ind = get_ind(xyz_train;tt_lim=[df_comp.t_start[TL_i],df_comp.t_end[TL_i]]) # get Boolean indices
end;
...
md"Select a flight line from Flight 1006 (see [readme](https://github.com/MIT-AI-Accelerator/MagNav.jl/blob/master/readmes/Flt1006_readme.txt)) to compare different compensation models.
"

# ╔═╡ 39bdbe6a-52ae-44d2-8e80-2e7d2a75e322
begin
	flight_test = :Flt1006 # select flight, full list of SGL flights is in df_flight
...
comp_test(lines_test, df_all, df_flight, df_map, comp_params_lin);
...
(TL_perm, TL_induced, TL_eddy, TL_aircraft, B_unit, _, y_nn, _, y, y_hat, _, _) =
	comp_m3_test(lines_test, df_nav, df_flight, df_map, comp_params; silent=true);
...
* `traj`: trajectory (GPS) struct information
* `ins`: INS struct information
...
git-tree-sha1 = "c2fd9099fb1e1f770d9f111d923f3406dc2e2e6a"
...
git-tree-sha1 = "0f6244c2ee653a8dc3a892ca8e8ac759ba57641e"
